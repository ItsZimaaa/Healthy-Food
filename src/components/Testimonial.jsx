...
export default function Testimonial() {
    return (
        <div className="h-full flex justify-center items-center paddingY-2 mt-10">
            <div className="flex flex-col justify-center items-center">
                <div className="flex flex-col justify-center items-center text-center md:w-[700px]">
                    <span className="w-[500px] flex flex-col items-center">
                        <h1 className='heading2'>Testimonial</h1>
                        <h2 className='heading w-[400px]'>Making Food great again and again</h2>
                    </span>

                    <p className='paragraph w-[400px] mt-4'>
                ...
                <div className="flex flex-col items-center gap-6 text-center mt-20 mb-20">

                    <img src={Profile} className="rounded-full w-[75px] h-[75px] object-cover" />

                    <div className="flex items-center w-[350px] gap-8">
